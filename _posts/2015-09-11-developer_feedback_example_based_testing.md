...
share: true
header:
  image: developer_feedback_ebt_banner.jpg
  teaser: developer_feedback_ebt_banner.jpg
---
...
{% capture fig_img %}
![Simple Feedback 02 by Trevithj - Own work. Licensed under CC BY-SA 3.0 via Commons - https://commons.wikimedia.org/wiki/File:Simple_Feedback_02.png#/media/File:Simple_Feedback_02.png]({{site.url}}{{site.baseurl}}/images/Simple_Feedback_02.png)
{% endcapture %}

{% capture fig_caption %}
A simple feedback loop - Simple Feedback 02 by Trevithj - Own work. Licensed under CC BY-SA 3.0 via Commons
{% endcapture %}
